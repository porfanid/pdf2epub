...
class TestAIPostprocessor:
    ...
    def test_get_system_prompt_success(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(
                processor, "_get_system_prompt", return_value=prompt_content
            ):
    ...
    def test_run_postprocessing_success(
        self, mock_process_markdown, mock_getjsonparams
    ):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Mock system prompt
            with patch.object(
                processor, "_get_system_prompt", return_value="test prompt"
            ):
