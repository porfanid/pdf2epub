...
class Anthropic_Analysis:
    ...
    def getjsonparams(system_prompt: str, request: str) -> str:
        ...
        try:
            ...
            logger.info(f"Response tokens: {message.usage.output_tokens if hasattr(message, 'usage') else 'unknown'}")
            ...
            logger.error("This could be due to network issues, API limits, or service problems")
            raise